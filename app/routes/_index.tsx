...
export default function Index() {
  return (
    <main className="max-w-lg min-h-screen mx-auto py-16 text-center font-mono bg-neutral-50">
      ...
      >
        <p className="flex-1 px-3">
          <input
            ...
            type="text"
            name="message"
            className="w-full h-12 px-3 py-2 border rounded border-gray-400 caret-gray-500 placeholder:text-gray-400"
          />
        </p>
        <button
          type="submit"
          className="w-14 mr-2 border border-transparent rounded bg-blue-500 text-white"
        >
          입력
        </button>
      </Form>
      ...
      <p className="mt-4 px-4 text-gray-500 text-sm">
        입력한 텍스트는 인공지능 학습에{' '}
        <a
